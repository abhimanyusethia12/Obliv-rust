...
use crate::prg;
use crate::utils::{gen_key, get_random_block, get_bit, grp_add, grp_sub, seed_xor};
use crate::FssKey;

use crate::{Block, Aeskey, S};
...
impl Gen {
    ...
    pub fn dpf <N : ArrayLength<Block> + 'static> (&self, sec_param : usize, key1 : &mut FssKey<N>, key2 : &mut FssKey<N>) {
        let n = self.num_bits;
